...
voice_cases = {case.get('name') for suite in suites for case in suite.iter('testcase')
               if case.get('classname') == 'com.ahmed9461.botos.media.OutgoingVoiceSessionTest'}
assert voice_cases == {
    'permissionDenialAndBotChangeNeverStartCapture',
    'recordedM4aIsPreviewedThenOneDurableVoiceSendAndFinalRelease',
    'botSwitchAfterRecordingDropsRawClipWithoutStagingOrSending',
    'failedStopOrExplicitAbortCannotLeaveAQueuedVoice',
    'emulatorMicrophoneRecordsValidatedAacMonoAndAbortRemovesRawFile',
