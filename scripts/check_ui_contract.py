...
for file in ['WorkspaceScreen.kt', 'SettingsScreens.kt', 'AccountScreen.kt']:
...
for resource in ['account.xml']:
    ...
    if ar != en: raise SystemExit('Account translations do not match')
